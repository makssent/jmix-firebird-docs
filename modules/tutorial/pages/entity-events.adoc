...
Слушатели {jmix-docs}/data-access/entity-events.html#entity-changed-event[EntityChangedEvent^] могут использоваться для поддержания согласованности данных и выполнения бизнес-логики в текущей {jmix-docs}/data-access/transactions.html[транзакции^] или после ее завершения.