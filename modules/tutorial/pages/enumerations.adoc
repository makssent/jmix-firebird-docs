...
Создайте файл `040-add-user-onboarding-status.xml` в каталоге `src/main/resources/com/company/onboarding/liquibase/changelog`. Он должен добавлять в таблицу `USER_` столбец `ONBOARDING_STATUS`.
