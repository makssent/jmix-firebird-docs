...
[WARNING]
====
Скрипт Liquibase Studio не сгенерирует - его нужно написать вручную, как показано в разделе xref:simple-crud.adoc#run-app[Запуск приложения] главы про CRUD. Скрипт должен добавлять в таблицу `USER_` столбец `DEPARTMENT_ID`, ограничение внешнего ключа и индекс по этому столбцу.
====
...
[WARNING]
====
Скрипт Liquibase Studio не сгенерирует - его нужно написать вручную, как показано в разделе xref:simple-crud.adoc#run-app[Запуск приложения] главы про CRUD. Скрипт должен создавать таблицу `USER_STEP` с ограничениями внешнего ключа и индексами для ссылок на `USER_` и `STEP`.
====
...
[WARNING]
====
Скрипт Liquibase Studio не сгенерирует - его нужно написать вручную, как показано в разделе xref:simple-crud.adoc#run-app[Запуск приложения] главы про CRUD. Скрипт должен добавлять в таблицу `USER_` столбец `JOINING_DATE`.
====
