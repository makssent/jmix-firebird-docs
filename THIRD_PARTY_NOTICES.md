...
- **Changes:** Tutorial text and navigation were adapted for Firebird. Most imported images, diagrams, and diagram source files are unchanged. The external login screenshot is unmodified. See `UPSTREAM.md` for details.
...
- **Source:** JetBrains s.r.o. and contributors; imported unchanged through the Jmix Documentation source identified above. Each file contains its original copyright and license notice.
