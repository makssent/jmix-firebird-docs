...
The imported tutorial was adapted for this project. The current branch contains the Russian version; the corresponding English adaptation is maintained in the `release_firebird_3.0` branch.
